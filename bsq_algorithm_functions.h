...
char			**fill_matrix(char **m, char *bff, int rc,
					struct s_param params);
struct s_pos	*put_obstacles(char **m, struct s_pos *obs,
					struct s_pos counter, struct s_param params);
void			calc_weight(char **m, struct s_pos *obs, struct s_pos counter,
